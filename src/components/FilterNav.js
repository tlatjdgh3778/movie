    ...
    return(
        <>
            <div className="NavContainer">
                    ...
                    <button onClick={onClick} className="top_rated"><FontAwesomeIcon icon={faSplotch}/><div className="top_rated">Top</div><div className="top_rated">Rated</div></button>           
                    <button onClick={onClick} className="now_playing"><FontAwesomeIcon icon={faPlay}/><div className="now_playing">Now</div><div className="now_playing">Playing</div>
                    </button>
            </div>
        </>
    );
